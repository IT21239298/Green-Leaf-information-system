...
const Map = ({ height, width }) => {
  ...
  useEffect(() => {
    ...
    async function addWaypoints(event) {
      ...
      // axios
      //   .post("https://6444192390738aa7c07f095c.mockapi.io/api/suppliers", {
      //     supID: "SUPG00",
      //     fname: "Amadee",
      //     lname: "Thennakkon",
      //     nic: "851472166v",
      //     address: "Demodara , Badulla rd",
      //     contactNo: "0748562123",
      //     age: "35",
      //     gender: "2",
      //     bank: "NSB",
      //     branch: "Badulla",
      //     accNo: "122353",
      //     accName: "A.Nisalasara",
      //     addressLat: map.current.unproject(event.point).lat.toString(),
      //     addressLng: map.current.unproject(event.point).lng.toString(),
      //   })
      //   .then((response) => {
