...
import MachinePartsFormDialog from "./MachinePartsFormDialog";
...
export default function CustomTable({
  ...
  const [openAddDriverDialog, setOpenAddMachinePartsDialog] =
  ...
  const handleDelete = (details) => {
    const machineParts = { id: details._id, machineID: details.machineID };

    axios
      .delete("http://localhost:8082/machineParts/delete", {
        data: machineParts,
