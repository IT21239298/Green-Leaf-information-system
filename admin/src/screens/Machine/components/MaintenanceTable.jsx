...
export default function CustomTable({
  ...
  const [openAddDriverDialog, setOpenAddMaintenanceDialog] =
  ...
  const handleDelete = (details) => {
    const maintenance = { id: details._id, machineID: details.machineID };

    axios
      .delete("http://localhost:8082/maintenance/delete", {
        data: maintenance,
